...
def c_t(t: Tensor) -> Tensor:
    return 2.0 * t - t.square()
...
def scalar_covariances(
    ...
    *,
    ...
    """Return S_t, C_t, Q_t for each sample by numerical quadrature.

    The covariance block is [[S_t I, C_t I], [C_t I, Q_t I]].
    """
    ...
    # Integral over s in [0, t], with s = t * u.
